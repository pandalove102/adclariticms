...
<input type="image" src="<?php echo SITEURL;?>/gateways/skrill/logo_large.png" style="width:200px" name="submit" class="wojo basic primary button" title="Pay With Skrill" alt="" onclick="document.mb_form.submit();">
  <input type="hidden" name="pay_to_email" value="<?php echo $this->gateway->extra;?>">
  <input type="hidden" name="return_url" value="<?php echo Url::url('/' . $this->core->system_slugs->account[0]->{'slug' . Lang::$lang}, "digishop");?>">
  <input type="hidden" name="cancel_url" value="<?php echo Url::url('/' . $this->core->system_slugs->account[0]->{'slug' . Lang::$lang}, "digishop");?>">
