      ...
      public function processLanguage()
      {
          ...
          if (empty(Message::$msgs)) {
              ...
              if (!Filter::$id) {
                  ...
                  if ($result = Db::run()->select(Content::cfTable)->results()) {
                      Db::run()->batchUpdate(Content::cfTable, "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate(Content::cfTable, "tooltip_" . $flag_id, "tooltip_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select(Content::eTable)->results()) {
                      Db::run()->batchUpdate(Content::eTable, "name_" . $flag_id, "name_en", $result);
                      Db::run()->batchUpdate(Content::eTable, "subject_" . $flag_id, "subject_en", $result);
                      Db::run()->batchUpdate(Content::eTable, "help_" . $flag_id, "help_en", $result);
                      Db::run()->batchUpdate(Content::eTable, "body_" . $flag_id, "body_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select(Content::lTable)->results()) {
                      Db::run()->batchUpdate(Content::lTable, "page_slug_" . $flag_id, "page_slug_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select(Membership::mTable)->results()) {
                      Db::run()->batchUpdate(Membership::mTable, "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate(Membership::mTable, "description_" . $flag_id, "description_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select(Content::mTable)->results()) {
                      Db::run()->batchUpdate(Content::mTable, "page_slug_" . $flag_id, "page_slug_en", $result);
                      Db::run()->batchUpdate(Content::mTable, "name_" . $flag_id, "name_en", $result);
                      Db::run()->batchUpdate(Content::mTable, "caption_" . $flag_id, "caption_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select("mod_adblock")->results()) {
                      Db::run()->batchUpdate("mod_adblock", "title_" . $flag_id, "title_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select("mod_events")->results()) {
                      Db::run()->batchUpdate("mod_events", "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate("mod_events", "venue_" . $flag_id, "venue_en", $result);
                      Db::run()->batchUpdate("mod_events", "body_" . $flag_id, "body_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  $sql = "
				  ALTER TABLE `mod_faq` 
					ADD COLUMN question_$flag_id VARCHAR (150) NOT NULL AFTER question_en,
					ADD COLUMN answer_$flag_id TEXT AFTER answer_en;";
                  Db::run()->pdoQuery($sql);

                  if ($result = Db::run()->select("mod_faq")->results()) {
                      Db::run()->batchUpdate("mod_faq", "question_" . $flag_id, "question_en", $result);
                      Db::run()->batchUpdate("mod_faq", "answer_" . $flag_id, "answer_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select("mod_gallery")->results()) {
                      Db::run()->batchUpdate("mod_gallery", "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate("mod_gallery", "slug_" . $flag_id, "slug_en", $result);
                      Db::run()->batchUpdate("mod_gallery", "description_" . $flag_id, "description_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select("mod_gallery_data")->results()) {
                      Db::run()->batchUpdate("mod_gallery_data", "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate("mod_gallery_data", "description_" . $flag_id, "description_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select("mod_timeline_data")->results()) {
                      Db::run()->batchUpdate("mod_timeline_data", "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate("mod_timeline_data", "body_" . $flag_id, "body_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select(Modules::mTable)->results()) {
                      Db::run()->batchUpdate(Modules::mTable, "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate(Modules::mTable, "info_" . $flag_id, "info_en", $result);
                      Db::run()->batchUpdate(Modules::mTable, "keywords_" . $flag_id, "keywords_en", $result);
                      Db::run()->batchUpdate(Modules::mTable, "description_" . $flag_id, "description_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select(Content::pTable)->results()) {
                      Db::run()->batchUpdate(Content::pTable, "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate(Content::pTable, "slug_" . $flag_id, "slug_en", $result);
                      Db::run()->batchUpdate(Content::pTable, "keywords_" . $flag_id, "keywords_en", $result);
                      Db::run()->batchUpdate(Content::pTable, "custom_bg_" . $flag_id, "custom_bg_en", $result);
                      Db::run()->batchUpdate(Content::pTable, "body_" . $flag_id, "body_en", $result);
                      Db::run()->batchUpdate(Content::pTable, "keywords_" . $flag_id, "keywords_en", $result);
                      Db::run()->batchUpdate(Content::pTable, "description_" . $flag_id, "description_en", $result);
                      unset($sql, $result);
                  ...
                  if ($result = Db::run()->select("plug_carousel")->results()) {
                      Db::run()->batchUpdate("plug_carousel", "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate("plug_carousel", "body_" . $flag_id, "body_en", $result);
                      unset($sql, $result);
                  }
                  ...
                  if ($result = Db::run()->select(Plugins::mTable)->results()) {
                      Db::run()->batchUpdate(Plugins::mTable, "title_" . $flag_id, "title_en", $result);
                      Db::run()->batchUpdate(Plugins::mTable, "body_" . $flag_id, "body_en", $result);
                      Db::run()->batchUpdate(Plugins::mTable, "info_" . $flag_id, "info_en", $result);
                      unset($sql, $result);
                  }
