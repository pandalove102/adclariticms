<?php
  ...
  class Utility
  {
      ...
      {
          //return base64_encode(openssl_encrypt(MCRYPT_RIJNDAEL_256, md5(INSTALL_KEY), $string, MCRYPT_MODE_CBC, md5(md5(INSTALL_KEY))));
      ...
      {
          //return rtrim(openssl_decrypt(MCRYPT_RIJNDAEL_256, md5(INSTALL_KEY), base64_decode($string), MCRYPT_MODE_CBC, md5(md5(INSTALL_KEY))), "\0");
