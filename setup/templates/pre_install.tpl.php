<div id="inner">
  ...
  <main>
    ...
    <p class="info">These settings are recommended for PHP in order to ensure full compatibility with Cms Pro.
      However, Cms Pro will still operate if your settings do not quite match the recommended.</p>
    <table class="data">
      <thead>
        <tr>
          <th>Extension</th>
    ...
    <p class="info">In order for Cms Pro to function correctly it needs to be able to access or write to certain files or directories. If you see "Unwriteable" you need to change the permissions on the file or directory to allow Cms Pro to write to it. </p>
    <div class="divider"></div>
    <table class="data">
...
<footer class="clearfix"> <small>current <b>cms pro v.5.0</b></small>
  <div id="buttons">
