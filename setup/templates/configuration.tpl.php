<form action="setup.php?step=2" method="post">
  <div id="inner">
    ...
    <main>
      ...
      <p class="info">Setting up Cms Pro to run on your server involves 3 simple steps. Please enter the hostname of the server Cms Pro is to be installed on. Enter the MySQL username, password and database name you wish to use with Cms Pro. </p>
      ...
      <p class="info">Configure correct paths and URLs to your Cms Pro.</p>
      <table class="data forms">
        <tr>
