  ...
  <div class="column" id="item_<?php echo $row->id;?>">
    <div class="wojo segment">
      ...
      <div class="row align-middle half-vertical-gutters no-gutters">
        <div class="columns"> <a data-set='{"option":[{"trash": "trashCoupon","title": "<?php echo Validator::sanitize($row->title, "chars");?>","id":<?php echo $row->id;?>}],"action":"trash","parent":"#item_<?php echo $row->id;?>"}' class="wojo icon basic negative tiny button action"> <i class="icon trash"></i> </a> </div>
