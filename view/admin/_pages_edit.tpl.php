...
?>
<h3><?php echo Lang::$word->META_T9;?></h3>
...
<form method="post" id="wojo_form" name="wojo_form">
        ...
        <div class="wojo fields">
          <div class="field">
            <div class="row half-gutters">
              <div class="columns shrink"> <a class="wojo tiny basic labeled icon button" href="<?php echo Url::url("/admin/builder/" . $lang->abbr, $this->data->id);?>"><i class="icon sliders horizontal"></i> <?php echo Lang::$word->PAG_SUB5;?></a> </div>
            </div>
    ...
    <div class="wojo attached segment form">
      ...
      <div class="wojo fields">
        ...
        <div class="field">
          ...
          <div class="wojo inline fields">
            <div class="wojo checkbox radio small slider field">
              <input name="is_comments" type="radio" value="1" <?php Validator::getChecked($this->data->is_comments, 1); ?>>
              <label><?php echo Lang::$word->YES;?></label>
            </div>
            <div class="wojo checkbox radio small slider field">
              <input name="is_comments" type="radio" value="0" <?php Validator::getChecked($this->data->is_comments, 0); ?>>
              <label><?php echo Lang::$word->NO;?></label>
            </div>
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="wojo inline fields">
            <div class="wojo checkbox radio small slider field">
              <input name="is_admin" type="radio" value="1" <?php Validator::getChecked($this->data->is_admin, 1); ?>>
              <label><?php echo Lang::$word->YES;?></label>
            </div>
            <div class="wojo checkbox radio small slider field">
              <input name="is_admin" type="radio" value="0" <?php Validator::getChecked($this->data->is_admin, 0); ?>>
              <label><?php echo Lang::$word->NO;?></label>
            </div>
          </div>
        </div>
  ...
  <div class="content-center"> <a href="<?php echo Url::url("/admin/pages");?>" class="wojo button"><?php echo Lang::$word->CANCEL;?></a>
    <button type="button" data-action="processPage" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->PAG_SUB3;?></button>
  </div>
