      ...
      <div class="wojo form attached acard">
        <div class="header basic" style="background:<?php echo $lang->color;?>;color:#fff">
          <div class="wojo fields">
            ...
            <div class="field five wide">
              <label class="transparent"><?php echo Lang::$word->CF_TIP;?></label>
              <div class="wojo huge transparent inverted input">
    ...
    <div class="wojo attached segment form">
      <div class="wojo fields">
        <div class="field five wide">
          ...
          <select name="section" class="wojo fluid dropdown selection">
      ...
      <div class="wojo fields">
        ...
        <div class="field five wide">
          ...
          <div class="wojo inline fields">
            ...
            <div class="wojo checkbox small radio slider field">
              <input name="required" type="radio" value="0" checked="checked">
              <label><?php echo Lang::$word->NO;?></label>
            </div>
          </div>
        </div>
...
<div class="row screen-block-3 tablet-block-2 mobile-block-1 phone-block-1 gutters align-center" id="sortable">
  ...
  <div class="column" id="item_<?php echo $row->id;?>" data-id="<?php echo $row->id;?>">
    <div class="wojo boxed attached segment">
      ...
      <div class="wojo bottom right attached simple label icon"> <a data-set='{"option":[{"delete": "deleteField","title": "<?php echo Validator::sanitize($row->{'title' . Lang::$lang}, "chars");?>","id":<?php echo $row->id;?>}],"action":"delete","parent":"#item_<?php echo $row->id;?>"}' class="action"> <i class="icon negative trash"></i> </a></div>
      <h5 class="content-center"><a href="<?php echo Url::url(Router::$path, "edit/" . $row->id);?>" class="inverted"><?php echo $row->{'title' . Lang::$lang};?></a> </h5>
