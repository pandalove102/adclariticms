    ...
    $.Timeline = function(settings) {
        ...
        $('.multipick').on('click', function() {
            $.get(config.url + '/managerBuilder.php', {
                ...
                var modal = '<div id="fileModal" class="wojo large modal">' + data + '</div>';
                $(modal).modal('setting', 'onShow', function() {
                    ...
                    $("#fInsert").on('click', function() {
                        ...
                        $("#result .highlite").each(function() {
                            ...
                            html +=
                                '<div class="column"> ' +
                                '<div class="wojo boxed basic attached segment"> ' +
                                '<img src="' + config.upUrl + '/' + dataset.url + '" alt="" class="wojo normal basic image"> ' +
                                '<a class="wojo top right small simple icon attached label remove"><i class="icon trash negative"></i></a> ' +
