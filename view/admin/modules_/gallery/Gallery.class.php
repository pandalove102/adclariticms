<?php
   ...
   * @copyright 2016
   * @version $Id: Gallery.class.php, v1.00 2016-04-20 18:20:24 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  class Gallery
  {
      ...
      public function processPhoto()
      {
          ...
          if (empty(Message::$msgs)) {
			  ...
			  $html = '<div class="meta"> <span class="wojo bold large white text">' . $data['title' . Lang::$lang] . '</span><p>' . $data['description' . Lang::$lang] . '</p></div>';
