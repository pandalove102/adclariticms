    ...
    $.Gallery = function(settings) {
        ...
        $('#reorder').on('click', function() {
            if ($(this).children().hasClass('apps')) {
                ...
                $(config.sortable).pinto('destroy');
                $('.content, .description', config.sortable).hide();
                $(config.sortable).removeClass('blocks');
        ...
        $('#drag-and-drop-zone').on('click', function() {
            $(this).wojoUpload({
                ...
                onComplete: function() {
                    $("#fileList").after('<div id="done" class="content-center padding"><a class="wojo small primary button"><i class="icon check"></i>' + config.lang.done + '</a></div>');
        ...
        function add_file(id, file) {
            var template = '' +
                ...
                '<div id="description_' + id + '" class="description wojo tiny text"></div>' +
                '</div>' +
