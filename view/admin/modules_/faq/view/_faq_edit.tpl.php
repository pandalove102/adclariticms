...
?>
<h3> <?php echo Lang::$word->_MOD_FAQ_TITLE1;?></h3>
...
<form method="post" id="wojo_form" name="wojo_form">
  ...
  <div class="content-center"> <a href="<?php echo Url::url("/admin/modules", "faq/");?>" class="wojo button"><?php echo Lang::$word->CANCEL;?></a>
    <button type="button" data-url="modules_/faq" data-action="processFaq" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->_MOD_FAQ_UPDATE;?></button>
  </div>
