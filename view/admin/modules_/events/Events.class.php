<?php
  ...
  class Events
  {
      ...
      public function processEvent()
      {
		  ...
		  $filters['time_start_submit'] = 'string';
		  $filters['time_end_submit'] = 'string';
          ...
          if (empty(Message::$msgs)) {
              ...
              $datax = array(
                  'date_start' => Db::toDate($safe->date_start_submit, false),
                  'date_end' => Db::toDate($safe->date_end_submit, false),
                  'time_start' => Date::doStime($safe->time_start_submit),
                  'time_end' => Date::doStime($safe->time_end_submit),
