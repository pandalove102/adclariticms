...
?>
<h3> <?php echo Lang::$word->_MOD_EM_TITLE1;?></h3>
...
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo attached tabbed basic segment">
    ...
    <div class="wojo attached segment form">
      ...
      <div class="wojo fields">
        <div class="field">
          <label><?php echo Lang::$word->_MOD_EM_DATE_S;?> <i class="icon asterisk"></i></label>
          <div class="row">
        ...
        <div class="field">
          <label><?php echo Lang::$word->_MOD_EM_DATE_SE;?> <i class="icon asterisk"></i></label>
          <div class="row">
            <div class="column screen-70 tablet-70">
              <div class="wojo fluid calendar left icon joint start input" data-datepicker="true">
      ...
      <div class="wojo fields">
        <div class="field">
          ...
          <div class="wojo action input">
            ...
            <div class="wojo basic icon button" data-color="true"><i style="background:<?php echo $this->data->color;?>" class="icon checkbox"></i></div>
          </div>
        </div>
        <div class="field">
  ...
  <div class="content-center"> <a href="<?php echo Url::url("/admin/modules", "events/");?>" class="wojo button"><?php echo Lang::$word->CANCEL;?></a>
    <button type="button" data-url="modules_/events" data-action="processEvent" name="dosubmit" class="wojo secondary button"><?php echo Lang::$word->_MOD_EM_UPDATE;?></button>
  </div>
