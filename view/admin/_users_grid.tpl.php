...
<div class="row half-gutters align-middle">
  ...
  <div class="columns shrink mobile-50 mobile-order-3 mobile-content-right">
    <div class="wojo small icon buttons"> <a href="<?php echo Url::url("/admin/users");?>" class="wojo icon button"><i class="icon reorder"></i></a> <a class="wojo icon active button"><i class="icon grid list"></i></a> <a href="<?php echo ADMINVIEW . '/helper.php?exportUsers';?>" class="wojo small button"><?php echo Lang::$word->EXPORT;?></a> </div>
  </div>
</div>
