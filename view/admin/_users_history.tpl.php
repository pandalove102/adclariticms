...
?>
<h3><?php echo Lang::$word->META_T3;?> <small>// <?php echo $this->data->fname;?> <?php echo $this->data->lname;?></small></h3>
<div class="wojo segment">
  <div id="legend" class="wojo small horizontal list align-right">
    <div class="item"><span class="wojo tiny empty circular label"> </span></div>
  </div>
...
<div class="row">
  <div class="column">
    <ul class="wojo tabs">
      ...
      <li><a data-tab="#pay"><i class="icon credit acard"></i> <?php echo Lang::$word->TRX_PAY;?></a></li>
    </ul>
  </div>
