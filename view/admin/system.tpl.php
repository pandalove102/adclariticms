...
<ul class="wojo tabs">
  <li class="active"><a data-tab="#cms"><i class="icon wojologo alt"></i> <?php echo Lang::$word->SYS_CMS_INF;?></a></li>
  <li><a data-tab="#php"><i class="icon code"></i> <?php echo Lang::$word->SYS_PHP_INF;?></a></li>
  <li><a data-tab="#server"><i class="icon desktop"></i> <?php echo Lang::$word->SYS_SER_INF;?></a></li>
  <li><a data-tab="#dbtables" class="last"><i class="icon data"></i> <?php echo Lang::$word->SYS_DBTABLE_INF;?></a></li>
</ul>
    ...
    <table class="wojo two basic column table">
      ...
      <tbody>
        <tr>
          ...
          <td>v<?php echo $this->core->wojov;?> <span id="version"> </span></td>
        </tr>
        <tr>
