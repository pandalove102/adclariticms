...
<div class="wojo segment">
  <form method="get" id="wojo_form" action="<?php echo Url::url(Router::$path);?>" name="wojo_form">
    <div class="row align-middle half-vertical-gutters">
      <div class="column screen-30 tablet-40 mobile-100 phone-100">
        <div class="wojo fluid small calendar left icon input" id="fromdate">
      ...
      <div class="column screen-30 tablet-40 mobile-100 phone-100">
        <div class="wojo fluid small calendar left icon action input" id="enddate"> <i class="calendar icon"></i>
      ...
      <div class="column shrink phone-hide"> <a href="<?php echo Url::url(Router::$path);?>" class="wojo small basic icon button"><i class="icon refresh"></i></a> </div>
      <div class="column content-right phone-content-center phone-100"> <a href="<?php echo ADMINVIEW;?>/helper.php?exportAllTransactions=1<?php echo Url::query();?>" class="wojo small primary icon button"><i class="icon spreadsheet"></i></a> </div>
    </div>
  </form>
  ...
  <div class="wojo small primary button"><?php echo Lang::$word->TRX_TOTAMT;?> <?php echo Utility::formatMoney(Stats::doArraySum($this->data, "total"));?></div>
</div>
