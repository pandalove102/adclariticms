...
<div class="row">
  <div class="column">
    <h3><?php echo Lang::$word->META_T7;?> <small>// <?php echo $this->data->{'title' . Lang::$lang};?></small></h3>
  </div>
  <div class="column shrink"><a href="<?php echo ADMINVIEW . '/helper.php?exportMembershipPayments&amp;id=' . $this->data->id;?>" class="wojo tiny secondary button"><?php echo Lang::$word->EXPORT;?></a></div>
</div>
