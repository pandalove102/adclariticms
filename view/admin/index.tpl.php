  ...
  <div class="row gutters">
    <div class="column screen-25 tablet-50 mobile-50 phone-100">
      <div class="wojo card">
        ...
        <div class="footer content-center wojo text"><?php echo Lang::$word->AD_RUSER;?></div>
      </div>
    </div>
    <div class="column screen-25 tablet-50 mobile-50 phone-100">
      <div class="wojo card">
        ...
        <div class="footer content-center wojo text"><?php echo Lang::$word->AD_AUSER;?></div>
      </div>
    </div>
    <div class="column screen-25 tablet-50 mobile-50 phone-100">
      <div class="wojo card">
        ...
        <div class="footer content-center wojo text"><?php echo Lang::$word->AD_PUSER;?></div>
      </div>
    </div>
    <div class="column screen-25 tablet-50 mobile-50 phone-100">
      <div class="wojo card">
        <div class="content content-center"><span class="wojo primary basic circular gigantic label"><?php echo $this->counters[3];?></span></div>
        <div class="footer content-center wojo text"><?php echo Lang::$word->AD_AMEM;?></div>
      </div>
    </div>
  </div>
