...
<div class="wojo basic plugin poll segment<?php echo ($conf[0]->alt_class) ? ' ' . $conf[0]->alt_class : null;?>">
  ...
  <div data-percent="<?php echo $percent;?>" class="wojo indicating progress active">
    <div class="bar" style="width: <?php echo $percent;?>%;"></div>
    <div class="label"><?php echo $percent;?>%</div>
  </div>
  <div class="wojo fluid buttons">
    <div class="wojo normal button"><?php echo Utility::formatMoney($row->total);?></div>
    <div class="or" data-text="<?php echo Lang::$word->OF;?>"></div>
    <div class="wojo normal primary button"><?php echo Utility::formatMoney($row->target_amount);?></div>
  </div>
