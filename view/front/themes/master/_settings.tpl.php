<?php
   ...
   * @copyright 2016
   * @version $Id: _settings.tpl.php, v1.00 2016-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      die('Direct access to this location is not allowed.');
?>
<div class="wojo center aligned header">
  <div class="content"> <?php echo Lang::$word->SETTINGS;?>
    <div class="sub header"><?php echo Lang::$word->M_INFO15;?></div>
  </div>
</div>
...
<div class="wojo-grid">
  <form method="post" id="wojo_form" name="wojo_form">
    <div class="wojo form">
      ...
      <div class="wojo fields align-middle">
        <div class="field four wide labeled">
          <label class="content-right mobile-content-left"><?php echo Lang::$word->M_ADDRESS;?> <i class="icon asterisk"></i></label>
        </div>
        <div class="field">
      ...
      <div class="wojo fields align-middle">
        <div class="field four wide labeled">
          <label class="content-right mobile-content-left"><?php echo Lang::$word->M_CITY;?> <i class="icon asterisk"></i></label>
        </div>
        <div class="field">
      ...
      <div class="wojo fields align-middle">
        <div class="field four wide labeled">
          <label class="content-right mobile-content-left"><?php echo Lang::$word->M_STATE;?> <i class="icon asterisk"></i></label>
        </div>
        <div class="field">
        ...
        <div class="field">
          <div class="wojo inline fields">
            <div class="wojo checkbox field">
              <input name="newsletter" type="checkbox" value="1" <?php Validator::getChecked($this->user->newsletter, 1); ?>>
          ...
          <div class="wojo block fields">
            ...
            <div class="field">
              <div class="wojo fluid icon input">
                ...
                <i class="icon google plus"></i> </div>
            </div>
          </div>
        </div>
      </div>
