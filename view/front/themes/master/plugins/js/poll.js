        ...
        bind: function() {
                ...
                if (typeof active !== "undefined") {
                    ...
                    $.post(base.settings.url, {
                        ...
                        if (json.type === "success") {
                            ...
                            $(".pollDisplay", base.element).velocity('transition.flipXOut', {
                                duration: 500,
                                complete: function() {
                                    $(".pollResult", base.element).velocity("transition.flipXIn", {
                                        duration: 150
                                    });
            ...
            $(this.element).on('click', '.pollView, .pollBack', function() {
                if ($(this).hasClass('pollView')) {
                    ...
                    $(".pollResult", base.element).velocity('transition.flipXOut', {
                        duration: 500,
                        complete: function() {
                            $(".pollDisplay", base.element).velocity("transition.flipXIn", {
                                duration: 150
                            });
